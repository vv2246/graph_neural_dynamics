...
A, params, func, x_train,y_train  = load_results("results/FHN_watts_strogatz_N_100_multiple_nn_True_0", device)
...
y_test = odeint(lambda y, t: func(y, t, A_test), x0_test[:,None], t, method="dopri5").squeeze().detach()
